...
import pl.mikolajp.cruddemo.entity.*;
...
public class CruddemoApplication {
    ...
    private void addMoreCoursesForStudent(AppDAO appDAO) {
        ...
        Course tmpCourse2 = new Course("Game Dev - how to make games with Unity engine");

        //add courses to student
        student.addCourse(tmpCourse1);
        student.addCourse(tmpCourse2);
    ...
    private void createCourseAndStudents(AppDAO appDAO) {
        //create a course
        Course tmpCourse = new Course("Winning - how to be a winner");

        //create the students
        Student tmpStudent1 = new Student("Adam", "Kowalski", "akowalski@example.com");
        Student tmpStudent2 = new Student("Marek", "Kowalski", "marekk@example.com");
